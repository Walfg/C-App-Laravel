            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="d-flex justify-content-center">Phone Number:<a class="text-info mx-1"
                                href="tel:{{ $card->phone_number }}">{{ $card->phone_number }}</a></p>
                        <p class="d-flex justify-content-center">Email: <a class="text-info mx-1" href="mailto:{{ $card->email }}">{{ $card->email }}</a></p>
